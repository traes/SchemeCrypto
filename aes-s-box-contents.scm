;hexadecimal representation of order of bytes in encryption S-Box
;(source: http://www.cs.eku.edu/faculty/styer/460/Encrypt/JS-AES.html)
(define s-encrypt-hex-list
  (list
...
;hexadecimal representation of order of bytes in decryption S-Box
;(source: http://www.cs.eku.edu/faculty/styer/460/Encrypt/JS-AES.html)
(define s-decrypt-hex-list
  (list
